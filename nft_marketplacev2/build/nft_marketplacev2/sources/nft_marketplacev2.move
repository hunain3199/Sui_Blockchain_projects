/*
/// Module: nft_marketplacev2
module nft_marketplacev2::nft_marketplacev2;
*/
...
module nft_marketplacev2::nft_marketplacev2 {
    ...
    // For displaying NFT image
    public struct NFT_MARKETPLACEV2 has drop {}

    // Part 3: Module initializer to be executed when this module is published

    fun init(otw: NFT_MARKETPLACEV2, ctx: &mut TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"description"),
            utf8(b"url"),

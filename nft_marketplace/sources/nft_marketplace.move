...
module nft_marketplace::nft_marketplace {
    ...
    /// Fetch the object ID of the `Marketplace`.
    public entry fun get_marketplace_id<COIN>(marketplace: &Marketplace<COIN>): ID {
        // Return the ID of the marketplace
        object::uid(&marketplace.id)
    }
